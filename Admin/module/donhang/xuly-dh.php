<?php 
	...
	// Lấy ngày hiện tại bằng PHP
	$now = date('Y-m-d'); // Định dạng ngày năm-tháng-ngày (YYYY-MM-DD)
	...
	if(isset($_GET['codehoadon']) && $status =='duyetdon')
	{
        ...
        if(mysqli_num_rows($query_thongke) == 0){
            ...
            $doanhthu = $doanhthu;
            $donhang = 1;
            $sql_update_thongke = mysqli_query($mysqli, "INSERT INTO thongke (ngay_thongke, soluongbanra_thongke, doanhthu_thongke, tongdon_thongke) VALUES ('$now', '$soluongban', '$doanhthu', '$donhang')");
