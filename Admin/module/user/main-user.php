        ...
        <table style="width:100%; text-align: center;" border="1px" cellspacing="0">
            ...
            ?>
                <tr style="height: 50px;">
					...
					<a href="http://localhost:3000/shopthucung/doan2/Admin/module/user/xoausers.php?iduser=<?php echo $row['id_user'] ?>" style="color: black;" onclick="return confirm('Bạn có chắc chắn muốn xóa người dùng này?');">Xóa</a>
                    </td>
                </tr>
            <?php
            }
